...
APPOINTMENT_MARKER = os.getenv('APPOINTMENT_MARKER')
WAITING_LIST_KEY_SUFFIX = os.getenv('WAITING_LIST_KEY_SUFFIX')
WAITING_LIST_TTL = os.getenv('WAITING_LIST_TTL')
FIRST_MESSAGE_KEY_SUFFIX = os.getenv('FIRST_MESSAGE_KEY_SUFFIX')
